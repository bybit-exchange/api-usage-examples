...
public class Test
{
	...
	public static void Main()
	{
		...
		string paramstr = "api_key=XXXXXXXX&side=Buy&symbol=BTCUSD&qty=100&price=3001.5&time_in_force=GoodTillCancel&order_type=Limit&reduce_only=true&timestamp=1542434791000";
