...
func main() {
	...
	//POST Method
	postParams := map[string]interface{}{"symbol": "BTCUSDT", "orderType": "Limit", "side": "Buy", "qty": "0.001", "price": "10000", "timeInForce": "GoodTillCancel", "category": "linear", "orderLinkId": "TEST1234"}
	postEndPoint := "/unified/v3/private/order/create"
	postRequest(c, http.MethodPost, postParams, postEndPoint)

	//GET Method
	getEndPoint := "/unified/v3/private/order/unfilled-orders"
	getParams := "category=linear&symbol=BTCUSDT"
