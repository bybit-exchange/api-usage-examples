...
func main() {
	...
	//POST Method
	postParams := map[string]interface{}{"symbol": "BTCUSDT", "side": "Buy", "positionIdx": 1, "orderType": "Limit", "qty": "0.001", "price": "10000", "timeInForce": "GoodTillCancel"}
	postEndPoint := "/contract/v3/private/order/create"
	postRequest(c, http.MethodPost, postParams, postEndPoint)

	//GET Method
	getEndPoint := "/contract/v3/private/order/unfilled-orders"
	getParams := "settleCoin=USDT"
