...
func main() {
	...
	//POST Method
	postParams := map[string]interface{}{"symbol": "BTCUSDT", "orderType": "Limit", "side": "Buy", "orderLinkId": "TEST1234", "orderQty": "0.001", "orderPrice": "10000", "timeInForce": "GTC"}
	postEndPoint := "/spot/v3/private/order"
	postRequest(c, http.MethodPost, postParams, postEndPoint)

	//GET Method
	getEndPoint := "/spot/v3/private/order"
	getParams := "orderLinkId=TEST1234"
